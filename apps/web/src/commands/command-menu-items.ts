...
export const COMMAND_MENU_ITEMS = [
  ...
  { id: "navigate.preferences", label: "Calendar preferences", detail: "Time zones, hours, and appearance", group: "Navigate", keywords: ["timezone", "theme", "sound", "default calendar", "primary color", "accent", "palette"], action: { kind: "route", to: "/settings/calendar" } },
